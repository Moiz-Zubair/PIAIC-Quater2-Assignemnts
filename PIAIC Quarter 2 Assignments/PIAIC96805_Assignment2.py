...
def function3():
    ...
    x = np.extract(condition, a)  # wrtie your code here
    return x
    """
    Expected Output:
...
def function12():
    ...
    b = np.repeat(arr[1], 3)
    c = np.repeat(arr[2], 3)
    ans = np.concatenate((a, b, c, arr, arr, arr)) # write your code here
...
def function15():
    ...
    ans = arr[arr[:, 1].argsort(kind='mergesort')]  # write your code here
